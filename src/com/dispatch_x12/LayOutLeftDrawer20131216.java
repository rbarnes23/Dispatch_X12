...
public class LayOutLeftDrawer20131216 extends Fragment implements OnClickListener {
...
//////////////////////////NEW STUFF	
	private void setMemberInfo() {
		...
		mMemberList = (ListView) root.findViewById(R.id.memberlist);

		memberAdapter = new MemberAdapter(mContext, mMemberInfo,
		...
		if (mMemberList.getHeaderViewsCount() < 1) {
			...
			View header = inflater.inflate(R.layout.memberheader,
					(ViewGroup) root.findViewById(R.id.memberheader));
